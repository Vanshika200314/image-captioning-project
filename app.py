...
# Load models from the local directory, as they are now inside the Docker container
...
# The if __name__ == '__main__': block is removed as it's not used by Gunicorn.